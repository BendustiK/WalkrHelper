...
net.createServer({ allowHalfOpen: true}, function (client) {
    ...
    function relay_connection(req) {
        console.log(req.method + ' ' + req.host + ':' + req.port + ' - ' + req);
        ...
        startService(
            client,
            { allowHalfOpen: true, port: req.port, host: req.host,  cert: fs.readFileSync('charles-proxy-ssl-proxying-certificate.crt'),},
            null,
